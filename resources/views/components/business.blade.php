...
<div class="mb-3">
    ...
    <input type="text" class="form-control" required  id="name" name="name" value="{{ $user->name }}" placeholder="Enter your business name" autofocus/>
...
<div class="mb-3">
    ...
    @foreach($vehicleTo as $v)
        <div class="form-check">
            <input type="radio" required  id="vehicle_to" name="vehicle_to" @php \App\Helpers\Helper::setChecked($user->vehicle_to, 'id', $v->id) @endphp value="{{ $v->id }}"/>
