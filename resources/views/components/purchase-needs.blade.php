...
<div class="mb-3">
    ...
    @foreach($purchasePurposes as $p)
        <div class="form-check">
            <input type="checkbox" @php \App\Helpers\Helper::setChecked($user->purchasePurposes ?? null, 'id', $p->id) @endphp class="d-inline"  id="purchase_purposes" name="purchase_purposes[]" value="{{ $p->id }}"/>
...
<div class="mb-3">
    ...
    @foreach($carStates as $p)
        <div class="form-check">
            <input type="checkbox" @php \App\Helpers\Helper::setChecked($user->carStates ?? null, 'id', $p->id) @endphp class="d-inline"  id="car_states" name="car_states[]" value="{{ $p->id }}"/>
...
<div class="mb-3">
    ...
    @foreach($toExport as $p)
        <div class="form-check">
            <input type="checkbox" @php \App\Helpers\Helper::setChecked($user->toExport ?? null, 'id', $p->id) @endphp class="d-inline"  id="to_export" name="to_export[]" value="{{ $p->id }}"/>
...
<div class="mb-3">
    ...
    @foreach($priceRanges as $p)
        <div class="form-check">
            <input type="checkbox" @php \App\Helpers\Helper::setChecked($user->priceRanges ?? null, 'id', $p->id) @endphp class="d-inline"  id="price_ranges" name="price_ranges[]" value="{{ $p->id }}"/>
...
<div class="mb-3">
    ...
    @foreach($experiensePeriods as $p)
        <div class="form-check">
            <input type="radio" @php \App\Helpers\Helper::setChecked($user->experiense_period ?? null, 'id', $p->id) @endphp class="d-inline"  id="experiense_period" name="experiense_period" value="{{ $p->id }}"/>
